...
- Announce: "I'm using the completing-task skill to complete this work."
- **REQUIRED SUB-SKILL:** Use superpowers:completing-task
...
- Never start implementation on production codebase without explicit user consent
